...
import { RouterRegistry } from '#servers/registry.js';
import { CallbackRegistry } from '#servers/registry.js';
import { ServiceRegistry } from './servers/registry.js';
...
server.initialize(AppDataSource, ServiceRegistry).then(_ => {
    server.start({
        host: HOST,
        port: PORT,
    });
